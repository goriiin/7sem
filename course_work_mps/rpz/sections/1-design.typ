...
#рис(image("/assets/struct.png"))[ Структурная схема ]<схем-структ>
...
#рис(image("/assets/image-main.png",height: 65%))[ Схема алгоритма основного цикла]<algo-1>


=== Алгоритм обработки обновления состояния вентилятора

Для автоматического управления охлаждением реализован алгоритм, предотвращающий частые переключения двигателя при колебаниях температуры около порогового значения. Схема алгоритма представлена на рисунке @algo-fan:
...
#рис(image("/assets/image-10.png", height: 65%))[ Схема алгоритма обработки обновления состояния вентилятора ]<algo-fan>
...
#рис(image("/assets/image-11.png"))[ Схема алгоритма обработки команды UART ]<algo-uart>
